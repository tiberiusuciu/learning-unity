...
public class TextController : MonoBehaviour {
	...
	void corridor_1 ()
	{
		text.text = "Still in the corridor. Floor still dirty. Hairclip in hand. Now what? You wonder if that lock on the closet would succumb to do some lock-picking?\n\n" +
	...
	void floor ()
	{
		text.text = "Rummaging around the dirty floor, you find a hairclip.\n\n" +
			"Press R to Return to the standing\nPress H to take the Hairclip.";
		if (Input.GetKeyDown(KeyCode.R)) {
			myState = States.corridor_0;
		}
	...
	void stairs_1 ()
	{
		text.text = "Unfortunately weilding a puny hairclip hasn't givenyou the confidence to walk out into a courtyard surrounded by armed guards!\n\n" +
	...
	void stairs_2 ()
	{
		text.text = "You feel smug for picking the closet door open, and are still armed with a hairclip (now badly bent). Even these achievements together don't give you the courage to climb up the stairs to your death!\n\n" +
			"Press R to Retreat down the stairs.";
		if (Input.GetKeyDown(KeyCode.R)) {
			myState = States.corridor_2;
		}
	...
	void cell_mirror ()
	{
		text.text = "You are still in your cell, and you STILL want to escape! There are " +
			"some dirty sheets on the bed, a mark where the mirror was, and that pesky door " +
	...
	void sheets_0 ()
	{
		...
		+ "change them. The pleasures of prison life I guess!\n\n"
	...
	void lock_0 ()
	{
		text.text = "This is one of those button locks. You have no idea what the combination " 
			+ "is. You wish you could somehow see wheree the dirty fingerprints were, maybe "
			+ "that would help.\n\n"
			+ "Press R to return to roaming your cell";
		if (Input.GetKeyDown(KeyCode.R)) {
			myState = States.cell;
